...
const [date,setDate]= useState(new Date())
  ...
  return (
       ...
       <div className='p-7 shadow-md   m-5 border-t-cyan-800 mx-10 md:mx-26 lg:mx-55 mt-20 ' >
         ...
         <h2 className='font-bold text-[28px] mt-3  flex items-center gap-3 mb-2'> <CalendarCheck className='text-[#039b95]'/>  Date and Time</h2>
 ...
 <DateTimeComponent  enabletimeSlotes={enabletimeSlotes}date={date} handleDate={handleDate} timeSlotes={timeSlotes} />
