...
const [date,setDate]= useState(new Date())
  ...
  return (
       ...
       <div className='p-7 shadow-md   m-5'>
         ...
         <h2 className='font-bold text-[28px] mt-3 flex items-center gap-3 mb-2'><Clock/>  Duration</h2>
             <h2>{eventInfo?.duration?eventInfo?.duration:"duration"} Min</h2>
           </div>

            <div >

         <h2 className='font-bold text-[28px] mt-3  flex items-center gap-3 mb-2'> <MapIcon/>  Program</h2>
