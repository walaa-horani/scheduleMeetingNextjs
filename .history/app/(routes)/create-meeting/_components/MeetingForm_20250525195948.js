...
function MeetingForm() {
  ...
  return (
    <div className='p-3'>
       <Link className='cursor-pointer' href={"/dashboard"}> <h1 className='flex gap-2 cursor-pointer'> <ChevronLeft/> Cancel</h1></Link>
        <div>
  ...
  <DropdownMenuContent>
    ...
    <DropdownMenuItem>60 Min</DropdownMenuItem>
                ...
                <Input placeholder="url"/></> }  
                    ...
                    <Button className="mt-10 w-full text-white">Create</Button>      
    </div>
  )
}
